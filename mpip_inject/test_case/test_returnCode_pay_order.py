...
class returnCode_pay_order(unittest.TestCase):
	# 读取文件
	data_file = '.\\test_data\\returnCode_pay_order.xlsx'
	url = "http://103.36.132.29:8080/mpip-gateway/pay/barcodepay"
	datalist = file_read.excel_table_value(filepath = data_file)
	data_key = ['mch_id','agent_id','v','timestamp','access_way','sn','time_expire',\
	'consumer_id','mch_trade_no','no_type','show_fee','real_fee','fee_type','title',\
	'app_type','channel_id','notify_url','ext','sign_type','goods_tag']
...
#		print success
	...
	# def test_case_041	(self,i=41): self.case_action(i) #需要支付
