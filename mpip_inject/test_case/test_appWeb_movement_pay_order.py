...
class appWeb_movement_pay_order(unittest.TestCase):
	# 读取文件
	data_file = '.\\test_data\\appWeb_movement_pay_order.xlsx'
	url = "http://103.36.132.29:8080/mpip-gateway/pay/barcodepay"
	datalist = file_read.excel_table_value(filepath = data_file)
	data_key = ['mch_id','agent_id','v','timestamp','access_way','sn','time_expire','consumer_id',\
	'mch_trade_no','no_type','show_fee','real_fee','fee_type','title','app_type','channel_id',\
	'notify_url','ext','sign_type','goods_tag']
...
#		print success
	...
	def test_case_187	(self,i=187): self.case_action(i)
	def test_case_188	(self,i=188): self.case_action(i)
	def test_case_189	(self,i=189): self.case_action(i)
	def test_case_190	(self,i=190): self.case_action(i)
	def test_case_191	(self,i=191): self.case_action(i)
	def test_case_192	(self,i=192): self.case_action(i)
	def test_case_193	(self,i=193): self.case_action(i)
	def test_case_194	(self,i=194): self.case_action(i)
	def test_case_195	(self,i=195): self.case_action(i)
	def test_case_196	(self,i=196): self.case_action(i)
	def test_case_197	(self,i=197): self.case_action(i)
	def test_case_198	(self,i=198): self.case_action(i)
	def test_case_199	(self,i=199): self.case_action(i)
