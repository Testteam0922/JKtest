...
# class AuthCode_refund_apply():
	# 读取文件
	data_file = '.\\test_data\\authCode_order_revoke.xlsx'
	url = "http://103.36.132.29:8080/mpip-gateway/pay/orderrevoke"
	datalist = file_read.excel_table_value(filepath = data_file)
	data_key = ['mch_id','agent_id','v','timestamp','access_way','mch_trade_no','mpip_no','third_no','sign_type']
