...
class authCode_refund_apply(unittest.TestCase):
# class AuthCode_refund_apply():
	# 读取文件
	data_file = '.\\test_data\\authCode_refund_apply.xlsx'
	url = "http://103.36.132.29:8080/mpip-gateway/pay/orderrefund"
	datalist = file_read.excel_table_value(filepath = data_file)
	data_key = ['mch_id','agent_id','v','timestamp','access_way','mch_refund_no','no_type','mch_trade_no','mpip_no','third_no','refund_fee','refund_fee_submit','ext','notify_url','sign_type']
