...
class Nest_Agent_Login(unittest.TestCase):
	
	data_file = ".\\test_data\\agent_login.xlsx"
	#读取数据
	...
	def Assertequal(self, i):
		...
		try:
			...
			if vlue:
				...
				fail_pic_path = case_pic_path + "Nest_Agent_Login_%s.png"%(i+1)
